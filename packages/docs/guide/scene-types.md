...
reads it. Add it to `include` once:
...
Without that line the file is written and ignored, and the addresses stay
un-suggested — which is the same behavior as not running the verb.
