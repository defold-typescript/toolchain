...
For a project created with `bunx @defold-typescript/cli@latest init path/to/project`, that is the destination folder you named — the same folder where you run the CLI commands.
