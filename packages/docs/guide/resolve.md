...
| [britzl/defold-sharing](https://github.com/britzl/defold-sharing) | `4.7.0` | `share` | `share/ext.manifest` |
| [selimanac/defold-uuid4](https://github.com/selimanac/defold-uuid4) | `v1.0` | `uuid4` | `uuid4/ext.manifest` |
| [selimanac/defold-tile-raycast](https://github.com/selimanac/defold-tile-raycast) | `v2.0.1` | `tile_raycast` | `tile-raycast/ext.manifest` |
