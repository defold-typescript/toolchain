...
```ts title="src/board.ts · the script"
...
```ts title="src/board.ts · input ids"
...
```ts title="src/board.ts · movement"
...
```ts title="src/grid.ts · clearLines"
...
```ts title="src/board.ts · lock & step"
...
```ts title="src/board.ts · hard drop"
...
```ts title="src/hud.ts · separate file"
...
```ts title="src/pieces.ts · complete"
import type { Cell } from "./grid";
...
```ts title="src/board.ts · complete"
