...
| `undocumentedMembers` | Upstream prose that reached neither the fork nor the import — a member whose upstream block is nothing but tags, leaving no summary to lower. |
