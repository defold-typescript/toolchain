...
export default createRoute((c) => {
  ...
  return c.render(
    <article class="prose">
      ...
      <h2>Global types</h2>
      <p>
        Core value types (<code>Vector3</code>, <code>Quaternion</code>, <code>Hash</code>, …) that
        Defold exposes as ambient globals. Hand-curated from <code>@defold-typescript/types</code>{" "}
        rather than generated from the Defold reference documentation.
      </p>
      <ul class="not-prose mt-4 grid list-none grid-cols-1 gap-3 p-0 sm:grid-cols-2">
        {globalTypePages.map((page) => (
          <li>
            <a
              href={withBase(page.route)}
              class="block rounded-lg border border-border bg-surface px-4 py-3 transition hover:border-border-strong hover:bg-surface-2"
