...
compute.set_constants("/main/compute.computec", { type: 0, value: 1 });
material.set_constants("/main/material.materialc", { type: 0, value: 1 });
model.set_blend_weights("#model", { 1: 0.5 });
