...
>
> The project is pre-1.0 and ships often — see the [changelog](https://defold-typescript.github.io/toolchain/changelog). The most useful thing you can do is **use** the toolchain on a real project and report what you hit:
>
