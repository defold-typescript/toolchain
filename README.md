...
- **Moving fast, pre-1.0** — the toolchain ships often, and the [changelog](https://defold-typescript.github.io/toolchain/changelog) calls out breaking changes first so an upgrade is never a surprise.
